...
We welcome contributions to the Rcognito project! Whether you want to
report a bug, request a new feature, or submit code changes, this
...
> project - Tweet about it - Refer this project in your project’s
...
[Issues](https://sanjayshetty01.github.io/issues) that might help you.
...
- Open an [Issue](https://sanjayshetty01.github.io/issues/new).
...
- Determine if your bug is really a bug and not an error on your side
  e.g. using incompatible environment components/versions. If you are
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://sanjayshetty01.github.io/RCognito/issues?q=label%3Abug).
...
> <shettysanjay01@gmail.com>.

We use GitHub issues to track bugs and errors. If you run into an issue
with the project:

- Open an [Issue](https://sanjayshetty01.github.io/issues/new). (Since
...
- Make sure that you are using the latest version.
- Read the documentationcarefully and find out if the functionality is
  already covered, maybe by an individual configuration.
- Perform a [search](https://sanjayshetty01.github.io/issues) to see if
...
issues](https://sanjayshetty01.github.io/issues).
...
[How to create a issue in
GitHub](https://docs.github.com/en/issues/tracking-your-work-with-issues/creating-an-issue)

[Your First Code
Contribution](https://github.com/firstcontributions/first-contributions)
